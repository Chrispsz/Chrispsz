# Olá, eu sou o Christovão 👋

**Estudante de ADS @ IFPB Cajazeiras** construindo projetos reais — de apps de estudo a launchers com CI/CD.
...
`TypeScript` `Next.js` `React` `Bun/Node` `Kotlin` `Python` `Tailwind CSS` `Prisma`

![GitHub stats](https://github-readme-stats.vercel.app/api?username=Chrispsz&show_icons=true&hide_border=true&count_private=true&theme=dracula)

### 📫 Contato

Abra uma issue em qualquer projeto ou me chame por aqui.
